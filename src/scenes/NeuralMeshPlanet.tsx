...
function Planet(): ReactElement {
  ...
  // planet had no specular highlights to lose (roughness 0.82, metalness 0.1).
  ...
  return (
    <div className="h-full w-full" ref={wrapperRef}>
      ...
      >
        ...
        <directionalLight color="#4FD1FF" intensity={1.5} position={[6, 4, 6]} />
        <directionalLight color="#FFB347" intensity={0.35} position={[-5, -2, -3]} />
        ...
        <EffectComposer>
          <Bloom intensity={0.45} luminanceSmoothing={0.9} luminanceThreshold={0.55} mipmapBlur />
        </EffectComposer>
      </Canvas>
    </div>
  );
